...
class UpdateSavedCarUseCase implements UseCase<SavedCarEntity, SavedCarEntity> {
  final ProfileRepository repository;

  UpdateSavedCarUseCase(this.repository);

  @override
  FutureEither<SavedCarEntity> call(SavedCarEntity params) {
    return repository.updateSavedCar(params);
  }
}
