...
class LoginAsGuestUseCase implements UseCase<UserEntity, String> {
  final AuthRepository _repository;

  LoginAsGuestUseCase(this._repository);

  @override
  Future<Either<Failure, UserEntity>> call(String userType) async {
    return await _repository.loginAsGuest(userType: userType);
  }
}
